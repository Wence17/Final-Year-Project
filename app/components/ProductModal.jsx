...
function ProductModal({
  ...
  return (
    <div
      ...
      className="fixed inset-0 bg-black/50 bg-opacity-25 backdrop-blur-sm flex justify-center items-center"
    >
          ...
          <form onSubmit={handleSubmit(sellItem)}>
            <div className="p-2">
              ...
              <div className="mb-4">
                ...
                {/* <div>
                        <select {...register("accountId")} className='w-full h-9 rounded-md p-2 text-sm border-2'>
                            {
            ...
            <div className="flex justify-end items-center space-x-2 p-2">
              ...
              <button
                type="submit"
                className="bg-pharmaGreen-700 hover:bg-pharmaGreen-800 text-white py-1 px-4 rounded"
              >
                Sell Item
              </button>
            </div>
