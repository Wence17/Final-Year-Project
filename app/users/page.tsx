...
function AddProduct() {
  ...
  const saveUser = async (user: any) => {
    try {
      if (isConnected) {
        ...
        console.log(
          "🚀 ~ file: index.js:66 ~ saveUser ~ contractInstance",
          contractInstance
        );
  ...
  const getMyAccountsList = useCallback(async () => {
    if (address) {
      setIsConnected(true);
    }
  ...
  }, [address, isConnected, setUsersList, signer]);
          ...
          <form onSubmit={handleSubmit(saveUser)}>
            <div className="">
              <div className="mb-4">
                ...
                <div>
                  <input
                    ...
                    className="w-full h-9 rounded-md p-2 text-sm border shadow-sm"
                    type="text"
                  />
                  {errors.name && (
              ...
              <div className="mb-4">
                <button
                  type="submit"
                  className="bg-pharmaGreen-800 px-4 py-2 text-white rounded-md hover:bg-pharmaGreen-900"
                >
                  {loading ? "Saving..." : "Save"}
                </button>
              </div>
