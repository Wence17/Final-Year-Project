...
// It checks if both myAccount and account.accountId are not zero addresses, ensuring that valid addresses are provided.

// It then checks the role of myAccount and the role of the account being added (account).

// If myAccount is a Manufacturer and account is a Distributor, it adds the account to the Manufacturer's Distributors list.
// If myAccount is a Distributor and account is a Retailer, it adds the account to the Distributor's Retailers list.
// If myAccount is a Retailer and account is a Customer, it adds the account to the Retailer's Customers list.
// If none of the above conditions match, it reverts the transaction with the message "Not valid operation."
    }
